...
where codestoquesaldo not in (select distinct mes.codestoquesaldo from tblestoquemes mes union select distinct conf.codestoquesaldo from tblestoquesaldoconferencia conf);
