...
select * from pendentes order by codnegocio asc 
--limit 50 offset 0
...
select * from tblpessoa where codpessoa = 11791




select * from tblnotafiscal t where codnotafiscal = 2475609


select * from tblprodutobarra where codproduto = 72300


select * from tblnegocio where codnegocio = 3254228