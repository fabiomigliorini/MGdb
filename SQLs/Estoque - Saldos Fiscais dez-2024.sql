-- Apaga View
drop MATERIALIZED VIEW mvwestoque2024 ;

-- Cria View
create materialized view mvwestoque2024  as
    select
	p.codproduto
	, p.produto
	, p.inativo
	...
	inner join tblestoquemes em on (em.codestoquemes = (select em2.codestoquemes from tblestoquemes em2 where em2.codestoquesaldo = es.codestoquesaldo and em2.mes <= '2024-12-31' order by mes desc limit 1))
